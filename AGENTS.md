...
These instructions apply to automation and coding agents working in `quaestor-ledger-test` repositories unless a repository defines stricter local policy.

## Durable engineering policy

- This repository defines public organization-wide defaults for `quaestor-ledger-test`.
...
- GitHub organization: https://github.com/quaestor-ledger-test
- Public organization defaults: https://github.com/quaestor-ledger-test/.github
...
3. Review linked pull requests, issues, Linear work, related repositories in `quaestor-ledger-test`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
